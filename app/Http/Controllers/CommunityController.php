 ...
 *         )
    ...
    * )
    */
    public function getUserCommunity($profileid){ //to show all community of a user 
        try{
    ...
    * )
    */
    public function showFollowedCommunities(Request $request){ //to show all followed community of a user 
        try{
            $validator = Validator::make($request->all(),[
                'profile_id'=>'required',
            ]);
   ...
   * @OA\Get(
    ...
    * )
    */
    public function showCommunityHistory($communityId){     //to show community history
        try {
    ...
    * )
    */
    public function showCommunityArti($communityId){  //to show list of community arti time 
        try {
